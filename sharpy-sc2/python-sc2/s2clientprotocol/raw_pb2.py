...
_ALLIANCE = DESCRIPTOR.enum_types_by_name['Alliance']
Alliance = enum_type_wrapper.EnumTypeWrapper(_ALLIANCE)
_CLOAKSTATE = DESCRIPTOR.enum_types_by_name['CloakState']
...
_STARTRAW = DESCRIPTOR.message_types_by_name['StartRaw']
_OBSERVATIONRAW = DESCRIPTOR.message_types_by_name['ObservationRaw']
_RADARRING = DESCRIPTOR.message_types_by_name['RadarRing']
_POWERSOURCE = DESCRIPTOR.message_types_by_name['PowerSource']
_PLAYERRAW = DESCRIPTOR.message_types_by_name['PlayerRaw']
_UNITORDER = DESCRIPTOR.message_types_by_name['UnitOrder']
_PASSENGERUNIT = DESCRIPTOR.message_types_by_name['PassengerUnit']
_RALLYTARGET = DESCRIPTOR.message_types_by_name['RallyTarget']
...
_ACTIONRAW = DESCRIPTOR.message_types_by_name['ActionRaw']
_ACTIONRAWUNITCOMMAND = DESCRIPTOR.message_types_by_name['ActionRawUnitCommand']
_ACTIONRAWCAMERAMOVE = DESCRIPTOR.message_types_by_name['ActionRawCameraMove']
_ACTIONRAWTOGGLEAUTOCAST = DESCRIPTOR.message_types_by_name['ActionRawToggleAutocast']
StartRaw = _reflection.GeneratedProtocolMessageType('StartRaw', (_message.Message,), {
...
ObservationRaw = _reflection.GeneratedProtocolMessageType('ObservationRaw', (_message.Message,), {
...
RadarRing = _reflection.GeneratedProtocolMessageType('RadarRing', (_message.Message,), {
  'DESCRIPTOR' : _RADARRING,
  '__module__' : 's2clientprotocol.raw_pb2'
  # @@protoc_insertion_point(class_scope:SC2APIProtocol.RadarRing)
  })
_sym_db.RegisterMessage(RadarRing)

PowerSource = _reflection.GeneratedProtocolMessageType('PowerSource', (_message.Message,), {
...
PlayerRaw = _reflection.GeneratedProtocolMessageType('PlayerRaw', (_message.Message,), {
...
UnitOrder = _reflection.GeneratedProtocolMessageType('UnitOrder', (_message.Message,), {
...
PassengerUnit = _reflection.GeneratedProtocolMessageType('PassengerUnit', (_message.Message,), {
...
RallyTarget = _reflection.GeneratedProtocolMessageType('RallyTarget', (_message.Message,), {
...
ActionRaw = _reflection.GeneratedProtocolMessageType('ActionRaw', (_message.Message,), {
...
ActionRawUnitCommand = _reflection.GeneratedProtocolMessageType('ActionRawUnitCommand', (_message.Message,), {
...
ActionRawCameraMove = _reflection.GeneratedProtocolMessageType('ActionRawCameraMove', (_message.Message,), {
...
ActionRawToggleAutocast = _reflection.GeneratedProtocolMessageType('ActionRawToggleAutocast', (_message.Message,), {
