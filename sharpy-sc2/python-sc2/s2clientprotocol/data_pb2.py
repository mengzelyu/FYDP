...
_ABILITYDATA = DESCRIPTOR.message_types_by_name['AbilityData']
_DAMAGEBONUS = DESCRIPTOR.message_types_by_name['DamageBonus']
_WEAPON = DESCRIPTOR.message_types_by_name['Weapon']
_UNITTYPEDATA = DESCRIPTOR.message_types_by_name['UnitTypeData']
_UPGRADEDATA = DESCRIPTOR.message_types_by_name['UpgradeData']
_BUFFDATA = DESCRIPTOR.message_types_by_name['BuffData']
_EFFECTDATA = DESCRIPTOR.message_types_by_name['EffectData']
_ABILITYDATA_TARGET = _ABILITYDATA.enum_types_by_name['Target']
_WEAPON_TARGETTYPE = _WEAPON.enum_types_by_name['TargetType']
AbilityData = _reflection.GeneratedProtocolMessageType('AbilityData', (_message.Message,), {
...
DamageBonus = _reflection.GeneratedProtocolMessageType('DamageBonus', (_message.Message,), {
...
UnitTypeData = _reflection.GeneratedProtocolMessageType('UnitTypeData', (_message.Message,), {
...
UpgradeData = _reflection.GeneratedProtocolMessageType('UpgradeData', (_message.Message,), {
...
EffectData = _reflection.GeneratedProtocolMessageType('EffectData', (_message.Message,), {
